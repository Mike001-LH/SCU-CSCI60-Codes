...
// Goals for Week 9: 
//   1. Finish implementing accessor/mutators (count, erase_one, erase)
//   2. Implement dynamic memory management functions (copy-constructor, ~, =)
//   3. Learn about iterators and implement one for Bag
...
void bagIteratorTests() {
  ...
  // TODO: compiler needs more instructions for a bag range-based for-loop
  /*for (int elem : b) {
    cout << elem << " ";
  }
  cout << endl;*/
